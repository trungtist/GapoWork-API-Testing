...
#    And   Check the task status "<statusEdit>"
    ...
    Examples:
      | title                            | workspace_id    | priority | status | priorityEdit | statusEdit |
      | Automation task: No priority     | 581770764199841 | 0        | 0      | 1            | 2          |
      | Automation task: Low priority    | 581770764199841 | 1        | 2      | 2            | 0          |
      | Automation task: Medium priority | 581770764199841 | 2        | 0      | 3            | 2          |
      | Automation task: High priority   | 581770764199841 | 3        | 2      | 0            | 0          |
...
#    And   Check the task title "<title>"
    ...
    Then Check success status
#    And   Check the task title "<title>"
    And  Check the tashas attachments "<new_name>"
    When  I delete the task "<workspace_id>"
    Then  Check success status
    When  I want to view the task detail "<workspace_id>"
    Then  Check failure status
